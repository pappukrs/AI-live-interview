...
const SettingsPage = () => {
  ...
  const handleSave = (provider: string) => {
    toast.success(`${provider} API key saved (mock)`);
  };
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <Card className="glass border-border/50">
          <CardHeader>
            ...
            <CardDescription>Bring your own API keys. Keys are encrypted and stored securely.</CardDescription>
          </CardHeader>
            ...
            {apiProviders.map((provider) => (
              <motion.div key={provider.id} initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button onClick={() => handleSave(provider.name)} variant="outline" size="icon">
